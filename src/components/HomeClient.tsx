        ...
        {introStage === "settled" && hasSelectedLang && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
            ...
            <footer className="mt-12 pt-6 border-t border-stone-200/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-400">
              ...
              <div className="flex items-center gap-3.5 shrink-0 text-stone-500">
                <Link
                  href="/journal"
                  className="font-medium hover:text-stone-900 transition hover:underline underline-offset-4"
                >
                  Journal →
                </Link>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 font-medium hover:text-stone-900 transition hover:underline underline-offset-4"
